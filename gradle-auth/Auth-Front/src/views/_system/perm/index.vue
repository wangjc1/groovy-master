        ...
        <el-card class="box-card">
          <div slot="header">
            <div class="title-box" style="padding-top: 10px; padding-bottom: 13px;">
              <span><el-tag type="warning" >菜单和按钮</el-tag>&nbsp;权限元数据</span>
          ...
          <el-tree ref="buttonPermTreeRef" :filter-node-method="filterNode" :data="buttonPermissionTree"
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
                <span>
                  ...
                  <el-tag v-if="data.ptype==permType.MENU && !menuPermValSet.has(data.pval)" class="mgl-10" type="danger" size="mini">未同步</el-tag>
                </span>
      ...
      <el-col :span="12">
        <el-card class="box-card">
          <div slot="header">
            ...
            <span class="tips-text">提示：接口菜单权限由后台定义，不提供任何编辑功能，实时读取@PermInfo注解值，不会同步到数据库。
              接口权限值建议使用前缀&nbsp;<el-tag size="mini" >a:</el-tag>，顶层模块必须以<el-tag size="mini" >:*</el-tag>结尾，以此来判断是否为非叶子节点
            </span>
          </div>
