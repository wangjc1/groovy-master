...
import com.wjc.constant.PermType;
...
import com.wjc.vo.sys.UpdateRolePermVo;
...
public class SysRoleController {
    ...
    public Json findRolePerms(@PathVariable Long rid){
