...
public class ArrayUtil {
    ...
    public static String toString(Collection<?> collection) {
        ...
        return MyStringUtil.subStrEndDiffStr(str.toString(), ",");
    }
	...
	public static boolean isExist(String str, Set<Object> sets) {
		String s[] = MyStringUtil.changeObjectArray(sets.toArray());
		return isExist(str, s);
	}

    public static void main(String[] args) {
        String ss = toString(new String[]{"1", "2"});
